...
internal sealed class CreateCurrentStudentEnrollmentValidator : AbstractValidator<CreateCurrentStudentEnrollmentCommand>
{
    public CreateCurrentStudentEnrollmentValidator()
    {
