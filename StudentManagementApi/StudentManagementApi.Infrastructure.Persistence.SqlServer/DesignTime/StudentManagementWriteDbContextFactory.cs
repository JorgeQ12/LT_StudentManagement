...
internal sealed class StudentManagementWriteDbContextFactory : IDesignTimeDbContextFactory<StudentManagementWriteDbContext>
{
    public StudentManagementWriteDbContext CreateDbContext(string[] args)
    {
        ...
        var options = new DbContextOptionsBuilder<StudentManagementWriteDbContext>().UseSqlServer(connectionString).Options;
        return new StudentManagementWriteDbContext(options);
    }
}
