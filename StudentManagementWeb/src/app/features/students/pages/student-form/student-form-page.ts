...
import { ApiProblemDetails, RegisterStudentRequest, StudentId } from '@core/api/api.models';
...
import { toAdminUpdate } from '../../services/students.dto';
...
export class StudentFormPage implements PendingChangesAware {
  ...
  protected async onSubmit(event: Event): Promise<void> {
    ...
    await submit(this.studentForm, async () => {
      try {
        if (this.id) {
          await this.facade.updateStudent(this.id, toAdminUpdate(this.model()));
        } else {
